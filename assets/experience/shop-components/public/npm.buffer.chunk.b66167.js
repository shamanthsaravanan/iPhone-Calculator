/*! For license information please see npm.buffer.chunk.b66167.js.LICENSE.txt */
"use strict";
    ...
    [8706], {
        7490: (t, r, e) => {
            ...
            function h(t, r, e) {
                ...
                if (N(t, ArrayBuffer) || t && N(t.buffer, ArrayBuffer)) return l(t, r, e);
                if ("undefined" != typeof SharedArrayBuffer && (N(t, SharedArrayBuffer) || t && N(t.buffer, SharedArrayBuffer))) return l(t, r, e);
                ...
                if (i) return i;
                if ("undefined" != typeof Symbol && null != Symbol.toPrimitive && "function" == typeof t[Symbol.toPrimitive]) return s.from(t[Symbol.toPrimitive]("string"), r, e);
            ...
            function c(t) {
                for (var r = t.length < 0 ? 0 : 0 | y(t.length), e = u(r), n = 0; n < r; n += 1) e[n] = 255 & t[n];
                return e
            }
            ...
            function l(t, r, e) {
                ...
                var n;
                return n = void 0 === r && void 0 === e ? new Uint8Array(t) : void 0 === e ? new Uint8Array(t, r) : new Uint8Array(t, r, e), Object.setPrototypeOf(n, s.prototype), n
            }
            ...
            function v(t, r, e, n, i) {
                ...
                if ("string" == typeof e ? (n = e, e = 0) : e > 2147483647 ? e = 2147483647 : e < -2147483648 && (e = -2147483648), Y(e = +e) && (e = i ? 0 : t.length - 1), e < 0 && (e = t.length + e), e >= t.length) {
                    if (i) return -1;
                    e = t.length - 1
                } else if (e < 0) {
                    if (!i) return -1;
                ...
                if ("string" == typeof r && (r = s.from(r, n)), s.isBuffer(r)) return 0 === r.length ? -1 : b(t, r, e, n, i);
            ...
            s.TYPED_ARRAY_SUPPORT = function() {
                ...
                if (N(t, Uint8Array) && (t = s.from(t, t.offset, t.byteLength)), N(r, Uint8Array) && (r = s.from(r, r.offset, r.byteLength)), !s.isBuffer(t) || !s.isBuffer(r)) throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
                if (t === r) return 0;
                ...
                for (e = 0; e < t.length; ++e) {
                    var o = t[e];
                    if (N(o, Uint8Array)) i + o.length > n.length ? s.from(o).copy(n, i) : Uint8Array.prototype.set.call(n, o, i);
                    else {
                ...
                var t = this.length;
                return 0 === t ? "" : 0 === arguments.length ? L(this, 0, t) : w.apply(this, arguments)
                ...
                if (N(t, Uint8Array) && (t = s.from(t, t.offset, t.byteLength)), !s.isBuffer(t)) throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof t);
                if (void 0 === r && (r = 0), void 0 === e && (e = t ? t.length : 0), void 0 === n && (n = 0), void 0 === i && (i = this.length), r < 0 || e > t.length || n < 0 || i > this.length) throw new RangeError("out of range index");
                if (n >= i && r >= e) return 0;
                if (n >= i) return -1;
                if (r >= e) return 1;
                if (this === t) return 0;
                for (var o = (i >>>= 0) - (n >>>= 0), f = (e >>>= 0) - (r >>>= 0), u = Math.min(o, f), h = this.slice(n, i), a = t.slice(r, e), p = 0; p < u; ++p)
                    if (h[p] !== a[p]) {
                        o = h[p], f = a[p];
                        break
                    }
            ...
            function _(t, r, e, n, o) {
                return r = +r, e >>>= 0, o || P(t, 0, e, 4), i.write(t, r, e, n, 23, 4), e + 4
            }

            function j(t, r, e, n, o) {
                return r = +r, e >>>= 0, o || P(t, 0, e, 8), i.write(t, r, e, n, 52, 8), e + 8
            }
            s.prototype.slice = function(t, r) {
                ...
                return t >>>= 0, r || x(t, 4, this.length), i.read(this, t, !0, 23, 4)
            }, s.prototype.readFloatBE = function(t, r) {
                return t >>>= 0, r || x(t, 4, this.length), i.read(this, t, !1, 23, 4)
            }, s.prototype.readDoubleLE = function(t, r) {
                return t >>>= 0, r || x(t, 8, this.length), i.read(this, t, !0, 52, 8)
            }, s.prototype.readDoubleBE = function(t, r) {
                return t >>>= 0, r || x(t, 8, this.length), i.read(this, t, !1, 52, 8)
...
//# sourceMappingURL=npm.buffer.chunk.b66167.js.map